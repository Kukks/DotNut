...
public interface ICashuApi : IDisposable
{
    ...
    Task<PostSwapResponse> Swap(
        PostSwapRequest request,
        CancellationToken cancellationToken = default
    );

    Task<TResponse> CreateMintQuote<TResponse, TRequest>(
        string method,
        TRequest request,
        CancellationToken cancellationToken = default
    );

    Task<TResponse> CreateMeltQuote<TResponse, TRequest>(
        string method,
        TRequest request,
        CancellationToken cancellationToken = default
    );

    Task<TResponse> Melt<TResponse, TRequest>(
        string method,
        TRequest request,
        CancellationToken cancellationToken = default
    );
    ...
    Task<TResponse> Mint<TRequest, TResponse>(
        string method,
        TRequest request,
        CancellationToken cancellationToken = default
    );
    ...
    Task<PostRestoreResponse> Restore(
