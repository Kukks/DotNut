    ...
    : IMintHandler<PostMintQuoteBolt12Response, List<Proof>>
{
    ...
    {
        this._signature = privkey.SignMintQuote(quote.Quote, outputs.Select(o=>o.BlindedMessage).ToList());
        return this;
    }
    ...
    public async Task<List<Proof>> Mint(CancellationToken ct = default)
    {
        ...
        {
            throw new ArgumentNullException(nameof(this._signature), $"Signature for mint quote {quote.Quote} is required!");
        }
